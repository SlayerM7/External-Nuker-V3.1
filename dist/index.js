...
function toolStart() {
  ...
  request_1.default(
    {
      url: "https://external-nuker-api-2.0w218021.repl.co/update",
      method: "GET",
      json: {
        Version: 3.2,
      },
    ...
    (err, res, body) => {
      if (res.body.status === true) {
        ...
        console.log(" ");
        console.log(
          createString_1.createString(
            "You are on a out-dated version",
            "semi",
            "fail"
          )
        );
        console.log(" ");
        rl.question(
          createString_1.createString("Type anything to update"),
          () => {
            open_1.default(res.body.message);
            console.log(" ");
            console.log(
              createString_1.createString("Closing window in 5 seconds", "semi")
            );
            setTimeout(() => {
              process.exit();
            }, 5000);
      ...
      rl.question(createString_1.createString("Enter option"), (option) => {
        if (option === "1") {
          ...
          console.log("");
          console.log(
            createString_1.createString("COMING SOON!", "semi", "fail")
          );
          setTimeout(() => {
            toolStart();
          }, 1500);
